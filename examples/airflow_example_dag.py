...
with DAG(
    ...
    # Credentials are read from AEGIS_API_URL and AEGIS_API_KEY env vars.
    ...
    run_quality_checks = AegisDQOperator(
        ...
        # To use Airflow Variables instead of env vars, uncomment these lines:
        # airflow_var_api_url="AEGIS_API_URL",
